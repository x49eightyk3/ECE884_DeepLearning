...
mozilla_basepath = os.path.dirname('/home/thallessilva/Documents/datasets/en')
urbansound_basepath = os.path.dirname('C:\Users\lindq\OneDrive\Desktop\Dataset\UrbanSound8K')
