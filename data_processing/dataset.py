...
class Dataset:
    def __init__(self, clean_filenames, noise_filenames, **config):
        ...
        #print("LOOK HERE!!!!!!! ----> ", clean_filenames)
    ...
    def parallel_audio_processing(self, clean_filename):
        #print("LOOK HERE!!!!!!! ----> ", clean_filename)
    ...
    def create_tf_record(self, *, prefix, subset_size, parallel=False):
        ...
        for i in range(0, len(self.clean_filenames), subset_size):
            ...
            tfrecord_filename = 'C:/Users/TruMoone/PycharmProjects/Records/' + prefix + '_' + str(counter) + '.tfrecords'
            ...
            #print("LOOK HERE!!!!!!! ----> ", clean_filenames_sublist)
